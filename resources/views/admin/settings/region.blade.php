...
@section('content')
    ...
    <form action="{{ route('admin.settings.updateRegion', $region->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex justify-between mt-2 p-2 flex-wrap md:flex-no-wrap">
            <h1 class="text-xl">Регион "{{ $region->region }}"</h1>
        </div>
        <div>
            <div class="p-2">
                ...
                <div class="flex mt-2">
                    ...
                    <div class="w-2/3">
                        <input type="text" name="name"
                               value="{{ !empty(old('name')) ? old('name') : $region->region }}"
