...
@section('content')
    ...
    <div class="flex items-center justify-center">
        <div class="container mt-16 lg:mt-24 p-2">
            <div>
                <a href="{{ route('admin.settings.getAddMaterialForm') }}" class="bg-blue-700 p-3 rounded hover:bg-blue-600">+ добавить</a>
            </div>
