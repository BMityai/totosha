...
@section('title', ': ' . $age->age)

@section('content')


    <form action="{{ route('admin.settings.updateAge', $age->id) }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex justify-between mt-2 p-2 flex-wrap md:flex-no-wrap">
            <h1 class="text-xl">Возраст "{{ $age->age }}"</h1>
        </div>
        <div>
            <div class="p-2">
                ...
                <div class="flex mt-2">
                    ...
                    <div class="w-2/3">
                        <input type="text" name="age"
                               value="{{ !empty(old('age')) ? old('age') : $age->age }}"
