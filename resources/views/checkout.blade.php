        ...
        <div class="cartInner block ">
            <div class="orderContent  rounded bg-blue-200 p-2 ">
                <form action="{{ route('createOrder') }}" method="POST">
                    ...
                    <p class="font-semibold text-lg text-center mt-4"> Контактные данные </p>
                    ...
                    <div class="font-bold  w-full">
                        <div class="orderPrice flex justify-between">
                            <p>Сумма заказа</p>
                            <p><span id="orderPrice" class="text-lg">{{ $totalPrice }}</span> ₸</p>
                        </div>
                        <div class="deliveryPrice flex justify-between">
                            <p>Доставка</p>
                            <p> <span id="deliveryPrice" class="text-lg">0</span> ₸</p>
                        </div>
                        <div id="totalSumm" class="flex justify-between">
                            <p>Итого к оплате</p>
