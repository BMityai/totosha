...
@section('content')
    <div class="container mt-16 ">
        ...
        <form id="filterForm" method="GET" action="{{ route('getSalesProducts') }}"
        ...
        <div class="categoryInner flex">
            <div class="sideFilterContent mt-6 text-lg">
                ...
                <form id="sideFilterForm" method="GET" action="{{ route('getSalesProducts') }}"
                      class="w-full">
                    <div class="mt-1">
                    ...
                    <p class="mt-2 text-center w-10/12 hover:bg-gray-300 rounded">
                        <a href="{{ route('getSalesProducts') }}">Сбросить фильтр</a>
                    </p>
                </form>
