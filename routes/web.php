...
Route::get('/admin/add_product', 'AdminPanel\AdminController@getAddProductForm')->name('admin.getAddProductForm');
Route::post('/admin/add_product', 'AdminPanel\AdminController@addProduct')->name('admin.addProduct');
